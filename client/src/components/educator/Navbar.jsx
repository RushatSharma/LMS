...
import Navbar from '../../components/student/Navbar' // Switched to Main Navbar
import Footer from '../../components/educator/Footer'

const Educator = () => {
    return (
        <div className="text-default min-h-screen bg-white dark:bg-background text-brand-dark dark:text-white transition-colors duration-300 font-jakarta">
            <Navbar />
            <div className='flex'>
                <SideBar />
