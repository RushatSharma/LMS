...
export const dummyTestimonial = [
    ...
    },
    {
        ...
        image: profile_img_2,
        rating: 4,
        feedback: 'The platform structure is amazing. I learned React in just 3 weeks and landed my first job. The community support is outstanding.',
    },
    {
        ...
        image: profile_img_3,
        rating: 4.5,
        feedback: 'Best investment for my career. The projects are real-world applicable and helped me build a solid portfolio.',
    },
    {
        name: 'Emily Davis',
        role: 'Product Designer @ Uber',
        image: profile_img_1, // Reusing image for demo
        rating: 5,
        feedback: 'The UI/UX course is top-notch. The instructors explain complex concepts in simple terms. Highly recommended!',
    },
    {
        name: 'Michael Brown',
        role: 'Data Scientist @ Netflix',
        image: profile_img_2, // Reusing image for demo
        rating: 4.5,
        feedback: 'Great content for data science. The Python track is comprehensive and covers everything from basics to advanced ML.',
    },
    {
        name: 'Sarah Wilson',
        role: 'Frontend Dev @ Microsoft',
        image: profile_img_3, // Reusing image for demo
        rating: 5,
        feedback: 'I loved the flexibility of the courses. Being able to learn at my own pace while working full-time was a game changer.',
    }
];
